...
import utils
from data_helper import TrainDataset, RuleDataset, construct_kg, get_kg, read_rules, GloNode
import hydra
...
def main(config: DictConfig):
    ...
    for epoch in range(n_epoch):
        ...
        val_metrics = evaluate(model, kg, ruleset.R, ruleset.R_mask, ruleset.IM, g.Ht, set_flag='valid')['average']
        ...
        if improvement_flag == '*':
            test_metrics = evaluate(model, kg, ruleset.R, ruleset.R_mask, ruleset.IM, g.Ht, set_flag='test')['average']
    ...
    train_metrics = evaluate(model, kg, ruleset.R, ruleset.R_mask, ruleset.IM, g.Ht, 'train')
    ...
    valid_metrics = evaluate(model, kg, ruleset.R, ruleset.R_mask, ruleset.IM, g.Ht, 'valid')
    ...
    test_metrics = evaluate(model, kg, ruleset.R, ruleset.R_mask, ruleset.IM, g.Ht, 'test')
